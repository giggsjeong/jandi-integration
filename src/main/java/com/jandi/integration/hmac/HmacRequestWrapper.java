...
class HmacRequestWrapper extends HttpServletRequestWrapper {
    ...
    public String getPayloadString() throws IOException {
        String returnString ;

        returnString = IOUtils.toString(getRequest().getReader());
